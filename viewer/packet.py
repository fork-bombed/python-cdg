...
class Packet:
    ...
    def decode(self):
        instructions = {
            ...
            COLOR_TABLE_UPPER:['Load Color Table (upper)',self._load_color_table],
    ...
    def _load_color_table(self):
        colors=[(self.data[i],self.data[i+1]) for i in range(0,len(self.data)-1,2)]
        return colors
